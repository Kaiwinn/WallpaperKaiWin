package com.example.wallpaperkaiwin.Model;
...
public class Photo {
    ...
    public Photo(int id, int width, int height, String url,
                 String photographer, String photographer_url,
                 int photographer_id, String avg_color, Src src,
                 boolean liked, String alt) {
        this.id = id;
        this.width = width;
        this.height = height;
        this.url = url;
